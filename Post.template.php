...
function template_main()
{
	...
	echo '
	<div class="m_sections active" id="a_post">
		<h3>', $context['page_title'], '</h3>
		<div id="a_post_info">
			<div id="postMoreOptions" class="reset smalltext">
	...
	echo '			
		...
		<div id="a_post_body">
			<div id="preview_section"', isset($context['preview_message']) ? '' : ' style="display: none;"', '>
				<h3><span id="preview_subject">', empty($context['preview_subject']) ? '' : $context['preview_subject'], '</span></h3>
			...
			echo '
							<script type="text/javascript"><!-- // --><![CDATA[
								...
								function addAttachment()
								{
									...
									setOuterHTML(document.getElementById("moreAttachments"), \'<dd class="smalltext"><input type="file" size="60" name="attachment[]" id="attachment\' + current_attachment + \'" class="input_file" /> (<a href="javascript:void(0);" onclick="cleanFileInput(\\\'attachment\' + current_attachment + \'\\\');">', $txt['clean_attach'], '</a>)\' + \'</dd><dd class="smalltext" id="moreAttachments"><a href="#" onclick="addAttachment(); return false;"> <span class="icon-down-open"></span>', $txt['more_attachments'], '<\' + \'/a><\' + \'/dd>\');

									return true;
								}
							// ]]></script>
						</dd>
						<dd class="smalltext" id="moreAttachments"><a href="#" onclick="addAttachment(); return false;"> <span class="icon-down-open"></span>', $txt['more_attachments'], '</a></dd>';
	...
	{
		echo '
					<div class="post_verification information">
			...
			echo '
				<div class="core_posts">
					<div class="content" id="msg', $post['id'], '">
						<h4>', $txt['posted_by'], ': ', $post['poster'], '</h4>
						<span>', $post['time'], '</span>	';
